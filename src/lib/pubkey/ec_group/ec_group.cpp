...
std::optional<EC_AffinePoint> EC_Group::Mul2Table::mul2(const EC_Scalar& x, const EC_Scalar& y) const {
   return m_tbl->mul2(x, y);
}

std::optional<EC_Scalar> EC_Group::Mul2Table::mul2_x_mod_order(const EC_Scalar& x, const EC_Scalar& y) const {
   return m_tbl->mul2_x_mod_order(x, y);
}
